	...
	<body>
		<div id="page">
			...
			<div id="sidebar">
				REPORT
				<ul>
					<li> <a href="RSP0.php" class="sidelinks"> Sales Report </a></li>
					<li> <a href="RPR0.php" class="sidelinks"> Purchase Report </a></li>
					<li> <a href="RCR0.php" class="sidelinks"> Cash Report </a></li>
				</ul>
			</div>
