...
<html>
	...
	<body>
		<div id="page">
			...
			<div id="body">				
				<h3>Input Data</h3>
				<form action="MC12.php" method="post">
					   ...
					   */
					   ...
					   if ($data['cnt'] == 0)
						  ...
						  */
					      ...
					      //echo "<tr><td>Cust-No			</td><td>:</td><td> <input type='text' name='CS_NO'     maxlength='08'  value=$mCSNO </td></tr>";
						  echo "<tr><td>Cust-No				</td><td>:</td><td> $mCSNO </td></tr>";
						  ...
						  echo "<tr><td>Telephone			</td><td>:</td><td> <input type='text' name='CS_PHONE' value='".$data['CS_PHONE']."'></td></tr>";
						  ...
						  echo "<input type='hidden' name='CS_NO' value=$mCSNO>";
